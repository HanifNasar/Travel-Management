...
import Avater from "../../banners/avatar.png"
const ProfileInfo = () => {
  return (
    <div className="bg-white p-4 border dark:bg-card-dark dark:border-dark rounded-lg mt-9">
      ...
      <div className="mt-3 pb-3 border-b dark:border-b-dark">
        <h1 className="heading text-center">John</h1>
